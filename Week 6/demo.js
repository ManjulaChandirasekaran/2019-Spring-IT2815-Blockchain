...
window.onload = function(){
    ...
    //All DOM function calls go here
     ...
     //Add event listeners to my buttons
     var button1 = document.getElementById("button1");
     button1.addEventListener("click",HideContent);//Donot add () after function name

     var button2 = document.getElementById("button2");
     button2.addEventListener("click",ShowContent);//Donot add () after function name

     var buttonChg = document.getElementById("button-chg");
     buttonChg.addEventListener("click",function(){
        ChangeStyle(this);
     });
     ...
     {
         //On MouseOver we will reset styles for link
         links[i].addEventListener("mouseover", function(){
             ChangeLinkStyle(this);
        });
        
        //On MouseOut we will reset styles for link
